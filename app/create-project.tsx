...
import { StaffMember, createCrmProject, fetchCrmStaffs, fetchCustomers } from "./utils/api";
  ...
  const handleSave = async () => {
    ...
    try {
      const result = await createCrmProject({
        ...
        project_rate_per_hour: ratePerHour || undefined,
        progress_from_tasks: "1",
        project_members: selectedMembers.length > 0 ? selectedMembers.map(m => String(m.staffid)) : undefined,
      });
      ...
      if (result.status) {
        ...
        Alert.alert("Error", result.message || "Failed to create project");
      }
    } finally {
      setSaving(false);
    }
        ...
        >
          ...
          <Section title="Customer *">
            {custSelected ? (
              ...
              <>
                <View style={[styles.searchWrap, errors.customer && styles.inputError]}>
                  ...
                  <TextInput
                    ...
                    autoCapitalize="none"
                  />
                  {custLoading && <ActivityIndicator size="small" color="#3b82f6" />}
                </View>
          ...
          <Section title="Team Members">
            ...
            >
              ...
              <Text style={styles.pickerToggleText}>
                {showMemberPicker ? "Close" : "Add Members"}
              </Text>
          ...
          <TouchableOpacity style={[styles.bottomBtn, saving && { opacity: 0.5 }]} onPress={handleSave} disabled={saving}>
            {saving ? <ActivityIndicator size="small" color="#fff" /> : (
              <>
                ...
                <Text style={styles.bottomBtnText}>Create Project</Text>
              </>
            )}
          </TouchableOpacity>
