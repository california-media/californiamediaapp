...
export default function AddLeadScreen() {
  ...
  const [phone, setPhone] = useState(existingLead?.phonenumber ?? '');
  ...
  useEffect(() => {
    Promise.all([
      apiGet('/lead_sources').catch(() => []),
      apiGet('/lead_statuses').catch(() => []),
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{isEdit ? 'Edit Lead' : 'Add Lead'}</Text>
        <View style={{ width: 40 }} />
      </View>
        ...
        >
          ...
          <View style={styles.card}>
            <View style={[styles.fieldRow, { alignItems: 'flex-start' }]}>
              <Ionicons name="document-text-outline" size={18} color="#6366f1" style={[styles.rowIcon, { marginTop: 2 }]} />
              <TextInput
                style={[styles.rowInput, styles.rowTextArea]}
                value={description}
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <Text
                      style={[styles.pickerOptionText, selected && styles.pickerOptionTextSelected]}
                    >
                      {item.label}
                    </Text>
...
const styles = StyleSheet.create({
  ...
  rowTextArea: { minHeight: 80, textAlignVertical: 'top', paddingTop: 2 },
