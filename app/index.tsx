...
export default function HomeScreen() {
  ...
  const loadData = async () => {
    try {
      const [allLeads, projectsData, secondaryData] = await Promise.all([
        fetchAllLeads(),
        fetchProjects(1, 6),
        // fetchProperties("Secondary", defaultFilters, 1, 6),
    ...
    >
      ...
      <View style={styles.projectsSection}>
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={() => router.push("/properties-list")}>
            <Text style={styles.seeAllText}>See All</Text>
          </TouchableOpacity>
        </View>
        ...
        {secondaryProperties.length > 0 ? (
          ...
          <View style={styles.emptyPropertiesContainer}>
            ...
            <Text style={styles.emptyPropertiesText}>
              No secondary properties available
            </Text>
          </View>
        )}
      </View>
